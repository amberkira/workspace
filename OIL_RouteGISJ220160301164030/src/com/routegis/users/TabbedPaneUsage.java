...
public class TabbedPaneUsage
{
    static
    {
        if (Configuration.isMacOS())
        {
            ...
            System.setProperty("com.apple.mrj.application.apple.menu.about.name", "RouteGIS SDK Tabbed Pane Application");
    ...
    public static class WWJPanel extends JPanel
    {
        ...
        protected void addShapes()
        {
            ...
            cone3.setAltitudeMode(MainClass.ABSOLUTE);
            ...
            cone4.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            mainFrame.setTitle("RouteGIS SDK Tabbed Pane");
            ...
            mainFrame.pack();
            PrivateUtil.alignComponent(null, mainFrame, AVKey.CENTER);
