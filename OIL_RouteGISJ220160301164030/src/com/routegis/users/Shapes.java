...
public class Shapes
{
    ...
    protected static class AppFrame extends JFrame
    {
        ...
        public AppFrame()
        {
            ...
            ApplicationTemplate.insertBeforePlacenames(this.wwjPanel.getMainWin(), layer);
            ...
            wwjPanel.getMainWin().addRenderingListener(new RenderingListener()
            {
        ...
        private void update()
        {
            ...
            this.wwjPanel.getMainWin().redraw();
        }
...
//            b.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
        ...
        {
            this.wwjPanel.getMainWin().addSelectListener(new SelectListener()
            {
                private PrivateIcon lastToolTipIcon = null;
                private BasicDragger dragger = new BasicDragger(AppFrame.this.wwjPanel.getMainWin());
                ...
                public void selected(SelectEvent event)
                {
                    ...
                    if (event.getEventAction().equals(SelectEvent.HOVER))
                    {
                        ...
                        if (lastToolTipIcon != null)
                        {
                            ...
                            AppFrame.this.wwjPanel.getMainWin().redraw();
                        }
                        ...
                        {
                            if (event.getTopObject() instanceof PrivateIcon)
                            {
                                this.lastToolTipIcon = (PrivateIcon) event.getTopObject();
...
//                        AppFrame.this.highlight(event.getTopObject());
                        ...
                        || event.getEventAction().equals(SelectEvent.DRAG))
                    {
                        ...
                        {
                            PickedObjectList pol = wwjPanel.getMainWin().getObjectsAtCurrentPosition();
                            if (pol != null)
                            {
//                                AppFrame.this.highlight(pol.getTopObject());
    ...
    private static final String APP_NAME = "RouteGIS SDK Shapes";
