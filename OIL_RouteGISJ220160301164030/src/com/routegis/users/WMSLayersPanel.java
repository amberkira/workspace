...
public class WMSLayersPanel extends JPanel
{
    ...
    protected void load()
    {
        ...
        // Gather up all the named layers and make a RouteGIS SDK layer for each.
    ...
    protected static Object createComponent(WMSCapabilities caps, AVList params)
    {
        ...
        try
        {
            ...
            Factory factory = (Factory) MainClass.createConfigurationComponent(factoryKey);
