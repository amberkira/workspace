...
public class WMSLayerManager
{
    ...
    protected static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected WMSLayersPanel addTab(int position, String server)
        {
            ...
            try
            {
                WMSLayersPanel layersPanel = new WMSLayersPanel(AppFrame.this.getMainWin(), server, wmsPanelSize);
                ...
                layersPanel.addPropertyChangeListener("LayersPanelUpdated", new PropertyChangeListener()
                {
                    ...
                    {
                        AppFrame.this.getLayerPanel().update(AppFrame.this.getMainWin());
                    }
                });
    ...
    {
        ApplicationTemplate.start("RouteGIS SDK WMS Layers", AppFrame.class);
    }
}
