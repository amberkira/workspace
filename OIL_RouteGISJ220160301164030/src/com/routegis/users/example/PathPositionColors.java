...
import com.routegis.users.util.ToolTipController;
...
public class PathPositionColors extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        public AppFrame()
        {
            ...
            path.setAltitudeMode(MainClass.CLAMP_TO_GROUND);
            ...
            // ordinal.
            this.setToolTipController(new ToolTipController(this.getMainWin())
            {
                @Override
    ...
    public static void main(String[] args)
    {
        ...
        ApplicationTemplate.start("RouteGIS SDK Path Position Colors", AppFrame.class);
    }
}
