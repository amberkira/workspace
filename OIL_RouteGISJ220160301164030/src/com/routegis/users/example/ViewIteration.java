...
import com.routegis.users.ApplicationTemplate.AppPanel;

import core.routegis.engine.geom.*;
import core.routegis.engine.view.orbit.BasicOrbitView;
...
public class ViewIteration extends ApplicationTemplate
{
    public static class AppFrame extends JFrame
    {
        ...
        protected class Forward extends PathAction
        {
            ...
            public void actionPerformed(ActionEvent actionEvent)
            {
                ...
                {
                    BasicOrbitView view = (BasicOrbitView) wwjPanel.getMainWin().getView();
        ...
        protected class FollowPath extends PathAction
        {
            ...
            public void actionPerformed(ActionEvent actionEvent)
            {
                for (Position p : path)
                {
                    final BasicOrbitView view = (BasicOrbitView) wwjPanel.getMainWin().getView();
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            frame.setTitle("RouteGIS SDK View Paths");
