...
public class PlacemarkDecluttering extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        public AppFrame()
        {
            ...
            this.getMainWin().getSceneController().setClutterFilter(new PlacemarkClutterFilter());
            ...
            pp.setAltitudeMode(MainClass.CLAMP_TO_GROUND);
...
//            attrs.setImageOffset(new Offset(19d, 8d, AVKey.PIXELS, AVKey.PIXELS));
            ...
            pp.setAltitudeMode(MainClass.ABSOLUTE);
            attrs = new PointPlacemarkAttributes();
            attrs.setScale(0.6);
            attrs.setImageOffset(new Offset(19d, 8d, AVKey.PIXELS, AVKey.PIXELS));
            attrs.setLabelOffset(new Offset(0.9d, 0.6d, AVKey.FRACTION, AVKey.FRACTION));
            attrs.setLineMaterial(new Material(PrivateUtil.makeRandomColor(null)));
...
//            attrs.setImageOffset(new Offset(0.5, 0.5, AVKey.FRACTION, AVKey.FRACTION));
    ...
    {
        ApplicationTemplate.start("RouteGIS SDK Placemark Decluttering", AppFrame.class);
    }
}
