...
import core.routegis.engine.layers.SurfaceImageLayer;
...
public class SurfaceImageViewer extends ApplicationTemplate
{
                    ...
                    public void run()
                    {
                        try
                        {
                            CompoundElevationModel cem
                                = (CompoundElevationModel) getMainWin().getModel().getGlobe().getElevationModel();
    ...
    {
        ApplicationTemplate.start("RouteGIS SDK Surface Images", SurfaceImageViewer.AppFrame.class);
    }
}
