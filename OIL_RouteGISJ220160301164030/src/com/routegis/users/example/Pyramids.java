...
public class Pyramids extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        public AppFrame()
        {
            ...
            pyramid3.setAltitudeMode(MainClass.ABSOLUTE);
            ...
            pyramid4.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            pyramid5.setAltitudeMode(MainClass.CLAMP_TO_GROUND);
            ...
            pyramid9.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            pyramid2.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            Pyramid pyramid6 = new Pyramid(Position.fromDegrees(30, 30, 750000), 1000000, 500000, 100000,
                Angle.fromDegrees(90), Angle.fromDegrees(45), Angle.fromDegrees(30));
            pyramid6.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            Pyramid pyramid7 = new Pyramid(Position.fromDegrees(60, 30, 750000), 1000000, 500000, 100000,
                Angle.fromDegrees(90), Angle.fromDegrees(45), Angle.fromDegrees(30));
            pyramid7.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            Pyramid pyramid8 = new Pyramid(Position.fromDegrees(-45, -180, 750000), 1000000, 500000, 100000,
                Angle.fromDegrees(90), Angle.fromDegrees(45), Angle.fromDegrees(30));
            pyramid8.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
    ...
    {
        ApplicationTemplate.start("RouteGIS SDK Pyramids", AppFrame.class);
    }
}
