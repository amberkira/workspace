...
import com.routegis.users.util.ExtentVisibilitySupport;
...
public class KeepingObjectsInView extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            this.viewController = new ViewController(this.getMainWin());
        ...
        protected void enableHelpAnnotation()
        {
            ...
            this.helpLayer.addRenderable(createHelpAnnotation(getMainWin()));
            insertBeforePlacenames(this.getMainWin(), this.helpLayer);
        }
        ...
        protected void disableHelpAnnotation()
        {
            ...
            this.getMainWin().getModel().getLayers().remove(this.helpLayer);
        ...
        protected void addObjectsToWorldWindow(Iterable<?> objectsToTrack)
        {
            ...
            {
                if (o instanceof PrivateIcon)
                    iconLayer.addIcon((PrivateIcon) o);
            ...
            {
                protected BasicDragger dragger = new BasicDragger(getMainWin());
    ...
    public static Iterable<?> createObjectsToTrack()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            PrivateIcon icon = new UserFacingIcon("images/antenna.png",
            ...
            attrs.setOutlineMaterial(new Material(PrivateUtil.makeColorBrighter(Color.BLUE)));
        ...
        protected void setImpl(double interpolant)
        {
            ...
            else
            {
                Position newCenterPos = Position.interpolateGreatCircle(interpolant, this.view.getCenterPosition(),
                    this.centerPosition);
                double newZoom = PrivateMath.mix(interpolant, this.view.getZoom(), this.zoom);
