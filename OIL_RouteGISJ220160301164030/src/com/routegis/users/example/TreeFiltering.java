...
import core.routegis.engine.util.BasicQuadTree;
...
public class TreeFiltering extends ApplicationTemplate
{
    private static class AppFrame extends ApplicationTemplate.AppFrame
    {
        public AppFrame() throws IOException, ParserConfigurationException, SAXException
        {
            ...
            this.getMainWin().addPositionListener(new PositionListener()
            {
    ...
    {
        ApplicationTemplate.start("RouteGIS SDK Filtering by Region", AppFrame.class);
    }
}
