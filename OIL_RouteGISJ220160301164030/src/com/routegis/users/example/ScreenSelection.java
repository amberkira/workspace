...
public class ScreenSelection extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            // that rectangle.
            this.screenSelector = new ScreenSelector(this.getMainWin());
            ...
            this.selectionHighlightController = new SelectionHighlightController(this.getMainWin(), this.screenSelector);
            this.getMainPanel().highlightController.dispose();
    ...
    {
        start("RouteGIS SDK Screen Selection", AppFrame.class);
    }
}
