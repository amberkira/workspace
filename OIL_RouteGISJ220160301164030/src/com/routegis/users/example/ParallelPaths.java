...
public class ParallelPaths extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        public AppFrame()
        {
            ...
            Globe globe = getMainWin().getModel().getGlobe();

            // Generate two sets of lines parallel to the control line. The positions will be added to the pathPosition lists.
            PrivateMath.generateParallelLines(positions, pathPositions1, pathPositions2, 50, globe);
            PrivateMath.generateParallelLines(positions, pathPositions3, pathPositions4, 100, globe);
    ...
    public static void main(String[] args)
    {
        ...
        ApplicationTemplate.start("RouteGIS SDK Multi Path", AppFrame.class);
    }
}
