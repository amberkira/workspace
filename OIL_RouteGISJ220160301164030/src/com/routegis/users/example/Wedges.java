...
public class Wedges extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        public AppFrame()
        {
            ...
            wedge3.setAltitudeMode(MainClass.ABSOLUTE);
            ...
            wedge4.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            wedge5.setAltitudeMode(MainClass.CLAMP_TO_GROUND);
            ...
            wedge9.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            wedge.setAltitudeMode(MainClass.ABSOLUTE);
            ...
            wedge2.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            Wedge wedge6 = new Wedge(Position.fromDegrees(30, 30, 750000), Angle.POS90, 500000, 500000, 500000,
                Angle.fromDegrees(90), Angle.fromDegrees(45), Angle.fromDegrees(30));
            wedge6.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            Wedge wedge7 = new Wedge(Position.fromDegrees(60, 30, 750000), Angle.POS90, 500000, 500000, 500000,
                Angle.fromDegrees(90), Angle.fromDegrees(45), Angle.fromDegrees(30));
            wedge7.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
            ...
            Wedge wedge8 = new Wedge(Position.fromDegrees(-45, -180, 750000), Angle.POS90, 500000, 1000000, 500000,
                Angle.fromDegrees(90), Angle.fromDegrees(45), Angle.fromDegrees(30));
            wedge8.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
        ...
        {
            for (Layer layer : getMainWin().getModel().getLayers())
            {
    ...
    {
        ApplicationTemplate.start("RouteGIS SDK Wedges", AppFrame.class);
    }
}
