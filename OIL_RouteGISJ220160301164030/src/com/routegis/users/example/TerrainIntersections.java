...
import core.routegis.engine.terrain.HighResolutionTerrain;
...
public class TerrainIntersections extends ApplicationTemplate
{
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            this.terrain = new HighResolutionTerrain(getMainWin().getModel().getGlobe(), TARGET_RESOLUTION);
            ...
            this.getMainWin().getModel().getLayers().add(this.gridLayer);

            this.intersectionsLayer = new RenderableLayer();
            this.intersectionsLayer.setName("Intersections");
            this.getMainWin().getModel().getLayers().add(this.intersectionsLayer);

            this.sightLinesLayer = new RenderableLayer();
            this.sightLinesLayer.setName("Sight Lines");
            this.getMainWin().getModel().getLayers().add(this.sightLinesLayer);
            ...
            this.getMainWin().getInputHandler().addMouseListener(new MouseAdapter()
            {
...
//            this.preCache(grid, this.referencePosition);
        ...
        protected void showIntersections(List<Position> intersections)
        {
            ...
            for (Position p : intersections)
            {
                ...
                pm.setAltitudeMode(MainClass.CLAMP_TO_GROUND);
        ...
        protected void showGrid(List<Position> grid, Position cPos)
        {
            ...
            {
                PointPlacemark pm = new PointPlacemark(p);
                pm.setAltitudeMode(MainClass.RELATIVE_TO_GROUND);
    ...
    public static void main(String[] args)
    {
        ...
        ApplicationTemplate.start("RouteGIS SDK Terrain Intersections", AppFrame.class);
    }
}
