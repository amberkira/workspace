...
public class ViewLimits extends ApplicationTemplate
{
    ...
    public static class Controller implements ActionListener
    {
        ...
        public Controller(AppFrame appFrame)
        {
            ...
            insertBeforePlacenames(this.appFrame.getMainWin(), this.layer);
            ...
            if (view != null)
            {
                ...
                if (limits != null)
                {
                    Globe globe = this.appFrame.getMainWin().getModel().getGlobe();
        ...
        public void saveObjects()
        {
            ...
            View view = this.appFrame.getMainWin().getView();
            String xmlString = view.getRestorableState();

            InOut.writeTextFile(xmlString, file);
        }
        ...
        public void loadObjects()
        {
            ...
            View view = this.appFrame.getMainWin().getView();
            String xmlString = InOut.readTextFile(file);
