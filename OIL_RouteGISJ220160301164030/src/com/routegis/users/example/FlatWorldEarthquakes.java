...
import com.routegis.users.ClickAndGoSelectListener;
import com.routegis.users.FlatWorldPanel;
import com.routegis.users.GeoJSONLoader;
...
import core.routegis.engine.formats.geojson.GeoJSONPoint;
...
public class FlatWorldEarthquakes extends ApplicationTemplate
{
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            controls.add(new FlatWorldPanel(this.getMainWin()));
            ...
            this.getMainWin().addSelectListener(new ClickAndGoSelectListener(
                this.getMainWin(), EqAnnotation.class, 1000e3));
        ...
        private String composeEarthquakeText(EqAnnotation eqAnnotation)
        {
            ...
            if (magnitude != null || !PrivateUtil.isEmpty(place))
            {
                sb.append("<b>");
            ...
            btZoom.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent event)
                {
                    if (latestEq != null)
                    {
                        ...
                        BasicOrbitView view = (BasicOrbitView) getMainWin().getView();
        ...
        {
            MainClass.getScheduledTaskService().addTask(new Runnable()
            {
                public void run()
                {
        ...
        private void downloadEarthquakes(String earthquakeFeedUrl)
        {
            ...
            if (newLayer.getNumRenderables() > 0)
            {
                ...
                insertBeforePlacenames(this.getMainWin(), this.eqLayer);
        ...
        private void addEarthquake(GeoJSONPoint geom, RenderableLayer layer, AVList properties)
        {
            ...
            eq.setAltitudeMode(MainClass.CLAMP_TO_GROUND); // GeoJON point's 3rd coordinate indicates depth
    ...
    public static void main(String[] args)
    {
        ...
        ApplicationTemplate.start("RouteGIS SDK USGS Earthquakes M 2.5+ - 7 days", AppFrame.class);
    }
}
