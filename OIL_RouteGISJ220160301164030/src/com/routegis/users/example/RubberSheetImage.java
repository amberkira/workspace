...
import core.routegis.engine.formats.gcps.GCPSReader;
import core.routegis.engine.formats.tab.TABRasterReader;
import core.routegis.engine.formats.worldfile.WorldFile;
...
public class RubberSheetImage extends ApplicationTemplate
{
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame implements ActionListener
    {
        ...
        public AppFrame()
        {
            ...
            this.getMainWin().addSelectListener(this.controller);
    ...
    public static class Controller implements ActionListener, SelectListener
    {
        ...
        public void actionPerformed(ActionEvent event)
        {
            ...
            if (PrivateUtil.isEmpty(actionCommand))
                return;
        ...
        {
            SurfaceImageEntry entry = new SurfaceImageEntry(this.appFrame.getMainWin(), surfaceImage, name);
            ...
            this.appFrame.getLayerPanel().update(this.appFrame.getMainWin());
        }
        ...
        protected void doSetImageOpacity(double opacity)
        {
            ...
            this.appFrame.getMainWin().redraw();
        }
        ...
        protected void loadFile(final File file)
        {
            ...
            if (si == null)
            {
                this.addNonGeoreferencedSurfaceImage(file, image, this.appFrame.getMainWin());
                return;
            }
    ...
    {
        return new BufferedImage(PrivateMath.powerOfTwoCeiling(minWidth), PrivateMath.powerOfTwoCeiling(minHeight),
    ...
    {
        ApplicationTemplate.start("Rubber Sheet Image", RubberSheetImage.AppFrame.class);
    }
}
