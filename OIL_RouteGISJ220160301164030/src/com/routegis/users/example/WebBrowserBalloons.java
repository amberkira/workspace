...
/**
 * Illustrates how to use browser balloons to display HTML, JavaScript, and Flash content to the user in the
 ...
 * attributes are specified by calling <code>{@link Balloon#setAttributes(core.routegis.engine.render.BalloonAttributes)}</code>
...
public class WebBrowserBalloons extends ApplicationTemplate
{
    protected static final String BROWSER_BALLOON_CONTENT_PATH
        = "data/BrowserBalloonExample.html";
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            this.hotSpotController = new HotSpotController(this.getMainWin());
            // Add a controller to handle link and navigation events in BrowserBalloons.
            this.balloonController = new BalloonController(this.getMainWin());
        ...
        protected void makeBrowserBalloon()
        {
            ...
            try
            {
                ...
                contentStream = InOut.openFileOrResourceStream(BROWSER_BALLOON_CONTENT_PATH, this.getClass());
                htmlString = InOut.readStreamToString(contentStream, null);
            }
            catch (Exception e)
            {
                e.printStackTrace();
            ...
            {
            	InOut.closeStream(contentStream, BROWSER_BALLOON_CONTENT_PATH);
            }

            if (htmlString == null)
                htmlString = Logging.getMessage("generic.ExceptionAttemptingToReadFile", BROWSER_BALLOON_CONTENT_PATH);

            Position balloonPosition = Position.fromDegrees(39.883056, 116.016389);
