...
import core.routegis.engine.layers.CrosshairLayer;
...
public class ViewLookAround extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public AppFrame()
        {
            ...
            this.vcp = new ViewControlPanel(getMainWin());
            getMainWin().setView(new BasicFlyView());
            ...
            getMainWin().getView().setEyePosition(pos);
        }
        ...
        private class ViewControlPanel extends JPanel
        {
            ...
            public ViewControlPanel(WorldWindow wwd)
            {
                ...
                insertBeforeCompass(getMainWin(), new CrosshairLayer());
...
//                    System.out.println("Orient: " + view.getHeading() + ", " + view.getPitch() + ", " + view.getRoll() );
    ...
    {
        ApplicationTemplate.start("RouteGIS SDK View Look Around", AppFrame.class);
    }
}