...
public class SlideShowAnnotation extends DialogAnnotation
{
    ...
    protected static final String PLAY_IMAGE_PATH = "com/rotuegis/users/images/16x16-button-play.png";
    protected static final String PAUSE_IMAGE_PATH = "com/rotuegis/users/images/16x16-button-pause.png";
    protected static final String PREVIOUS_IMAGE_PATH = "com/rotuegis/users/images/16x16-button-previous.png";
    protected static final String NEXT_IMAGE_PATH = "com/rotuegis/users/images/16x16-button-next.png";
    protected static final String BEGIN_IMAGE_PATH = "com/rotuegis/users/images/16x16-button-start.png";
    protected static final String END_IMAGE_PATH = "com/rotuegis/users/images/16x16-button-end.png";
    protected static final String INCREASE_IMAGE_PATH
        = "com/rotuegis/users/images/16x16-button-window-increase.png";
    protected static final String DECREASE_IMAGE_PATH
        = "com/rotuegis/users/images/16x16-button-window-decrease.png";
