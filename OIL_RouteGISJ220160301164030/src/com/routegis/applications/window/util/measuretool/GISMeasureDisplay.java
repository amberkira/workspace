...
public class GISMeasureDisplay implements MeasureTool.MeasureDisplay
{
    ...
    public GISMeasureDisplay(MeasureTool measureTool)
    {
    ...
    protected String getDisplayString(Position pos, MeasureTool mt)
    {
    ...
    protected Vec4 computeAnnotationPosition(Position pos, MeasureTool mt)
    {
    ...
    protected String formatCircleMeasurements(Position pos, MeasureTool mt)
    {
    ...
    protected String formatEllipseMeasurements(Position pos, MeasureTool mt)
    {
        StringBuilder sb = new StringBuilder();
    ...
    protected String formatSquareMeasurements(Position pos, MeasureTool mt)
    {
        StringBuilder sb = new StringBuilder();
    ...
    protected String formatQuadMeasurements(Position pos, MeasureTool mt)
    {
        StringBuilder sb = new StringBuilder();
    ...
    protected String formatPolygonMeasurements(Position pos, MeasureTool mt)
    {
        StringBuilder sb = new StringBuilder();
    ...
    protected String formatLineMeasurements(Position pos, MeasureTool mt)
    {
    ...
    protected void formatControlPoints(Position pos, MeasureTool mt, StringBuilder sb)
    {
    ...
    protected Double computeAccumulatedLength(LatLon pos, MeasureTool mt)
    {
    ...
    protected double computePathLength(MeasureTool mt)
    {
