...
public class MeasureTool extends AVListImpl
    implements Disposable, MouseListener, MouseMotionListener, SelectListener, PositionListener, RenderingListener
{
    ...
    public MeasureTool(final WorldWindow wwd, Renderable shape, String lineType, RenderableLayer controlPointsLayer)
    {
        if (wwd == null)
        {
    ...
    {
        return new MeasureToolControlPoints(this);
    }

    protected MeasureDisplay createMeasureDisplay()
    {
        return new GISMeasureDisplay(this);
    }
    ...
    public void setArmed(boolean armed)
    {
        ...
        {
            this.armed = armed;
            this.firePropertyChange(MeasureTool.EVENT_ARMED, !armed, armed);
        }
    }
        ...
        if (this.isArmed() && this.useRubberBand && mouseEvent.getButton() == MouseEvent.BUTTON1)
        {
            if ((mouseEvent.getModifiersEx() & MouseEvent.BUTTON1_DOWN_MASK) != 0)
            {
                if (!mouseEvent.isControlDown())
                {
                    ...
                    this.firePropertyChange(MeasureTool.EVENT_RUBBERBAND_START, null, null);
                }
            }
            mouseEvent.consume();
        }
    ...
    public void mouseReleased(MouseEvent mouseEvent)
    {
        if (this.isArmed() && this.useRubberBand && mouseEvent.getButton() == MouseEvent.BUTTON1)
        {
            ...
            autoDisarm();
            mouseEvent.consume();
            this.firePropertyChange(MeasureTool.EVENT_RUBBERBAND_STOP, null, null);
        }
...
//        }
    ...
    protected void doMoved()
    {
        if (this.active && rubberBandTarget != null && this.getWwd().getCurrentPosition() != null)
        {
                ...
                && !this.getMeasureShapeType().equals(AVKey.SHAPE_POLYGON)))
            {
                ...
                this.firePropertyChange(MeasureTool.EVENT_POSITION_REPLACE,
    ...
    protected void moveToPosition(Position oldPosition, Position newPosition)
    {
        ...
        this.firePropertyChange(MeasureTool.EVENT_POSITION_REPLACE, oldPosition, newPosition);
    }
    ...
    protected void highlight(Object o)
    {
        ...
        if (o != null && o instanceof MeasureTool.ControlPoint
            && ((MeasureTool.ControlPoint) o).getParent() != this)
