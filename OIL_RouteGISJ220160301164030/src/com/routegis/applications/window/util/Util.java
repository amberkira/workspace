...
public class Util
{
    ...
    {
        return Logger.getLogger("core.routegis.engine");
    }
    ...
    {
        String suffix = InOut.getSuffix(file.getPath());
    ...
    {
        if (PrivateUtil.isEmpty(linesString))
            return null;
    ...
    {
        if (PrivateUtil.isEmpty(wordsString))
            return null;
