...
import com.routegis.applications.window.core.layermanager.LayerManager;
import com.routegis.applications.window.features.NetworkActivitySignal;
...
public class Controller
{
    static
    {
        // The following is required to use Swing menus with the heavyweight canvas used by RouteGIS SDK.
    ...
    public GISBPanel getWWPanel()
    {
        return (GISBPanel) getRegisteredObject(Constants.WW_PANEL);
    }
    ...
    public void moveToLocation(LatLon location)
    {
        ...
        this.moveToLocation(new core.routegis.engine.geom.Position(location, newAlt));
    }
    ...
    public File determineSaveLocation(String dialogTitle, String defaultFolderName)
    {
        ...
        if (!PrivateUtil.isEmpty(defaultPath))
