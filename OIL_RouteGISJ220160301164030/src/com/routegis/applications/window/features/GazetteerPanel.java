...
import core.routegis.engine.exception.NoItemException;
import core.routegis.engine.poi.*;
...
public class GazetteerPanel extends AbstractFeature implements FeaturePanel
{
    ...
    private void createComponents(JPanel p)
    {
        ...
        JLabel label = new JLabel(
            ImageLibrary.getIcon("com/routegis/applications/worldwindow/images/safari-24x24.png"));
//            new ImageIcon(getClass().getResource("com/routegis/applications/worldwindow/images/safari-24x24.png")));
