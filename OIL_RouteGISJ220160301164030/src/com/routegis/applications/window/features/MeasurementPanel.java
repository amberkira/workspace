...
import com.routegis.applications.window.util.measuretool.MeasureTool;
...
public class MeasurementPanel extends AbstractFeaturePanel
{
    ...
    protected void installNewMeasureTool(String shapeType)
    {
        ...
        this.measureTool = new MeasureTool(this.controller.getWWd(), shape,
    ...
    protected void makeToolListener()
    {
        this.toolListener = new PropertyChangeListener()
        {
            public void propertyChange(PropertyChangeEvent event)
            {
                ...
                else if (event.getPropertyName().equals(MeasureTool.EVENT_POSITION_ADD))
                {
