...
public class AntennaAxes extends AbstractShape
{
    ...
    protected Font labelFont = Font.decode("ºÚÌå-PLAIN-14");
    ...
    protected void drawLabels(DrawContext dc)
    {
        ...
        // Compute the screen points at which to place the labels. These are all points on the RouteGIS SDK principal
